...
Il est donc inutile de créer un store from scratch. Comme nous allons créer une application Angular donc prenont **Ngrx**.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMzcyMjA1NjZdfQ==
-->