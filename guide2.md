...
// ... other      
```
Mettre à jour le all-todos pour ajouter un bouton selectTodo qui va lançer l'action de **SELECT_TODO** et faire un navigate sur la page de s 
```javascript
import { Store, select } from '@ngrx/store';
import { OnInit, Component, Inject } from '@angular/core';
import { FormBuilder, FormGroup, Validators } from '@angular/forms';
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExODYyNDQzNTRdfQ==
-->