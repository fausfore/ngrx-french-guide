...
Il reste des points comme les **Meta-reducers** ou le **router-store** que vous pouvez retrouver ces points manquant sur le [gitHub officelle de NGRX](https://github.com/ngrx/platform).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ1MDExMzk2NCwxODIwNzMxMTEwLDE1Nj
czMzE2NDJdfQ==
-->