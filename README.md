...
Il reste des points comme les **Meta-reducers** ou le **router-store** que vous pouvez retrouvé ces points manquant sur le [gitHub officelle de NGRX](https://github.com/ngrx/platform).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA3MzA2NDIsMTgyMDczMTExMCwxNTY3Mz
MxNjQyXX0=
-->