...
Cela nous permet de récupérer le *state* par défaut du *selector* mais en plus on peut **dispatch une action** dans notre test afin de tester le selector après une action x.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ3NzI1NzE1MV19
-->