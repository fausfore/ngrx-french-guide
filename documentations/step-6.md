...
Mais cela reste du local ou du offline, il est temps de n va pouvoir commencer a inclure les requêtes **http**, pour cela on va prendre le module npm de  **[JsonPlaceholder](https://jsonplaceholder.typicode.com/)** avec **npm install -g json-server**.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwODAxNzE2ODQsNTMyODk4MTUyXX0=
-->