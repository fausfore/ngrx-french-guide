...
```javascript
	...
	// ...reste
```
Voilà notre action **createTodo** est terminée, il reste des chose a revoir comme la gestion des ids mais ce soucis se réglera au moment ou utilisera une api qui elle se chargera de gérer ce point.


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ3NjI4OTIsMjEyMjc0ODA4OV19
-->