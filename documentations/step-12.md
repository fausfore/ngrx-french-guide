...
Si notre *todo-list* n'est plus un tableau mais plutôt une **entité** de *todo*, lors d'une action on ne fera pas une itération dans un tableau, à la place on lui passera directement une clef.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDUxMTY4MjIyLDEyMDY2ODE0ODUsLTIwMT
g3MDk3NDRdfQ==
-->