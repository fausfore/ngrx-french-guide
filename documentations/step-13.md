...
## Schematics
Depuis la version 5, Angular introduit les schematics, des templates de fichiers customizables, NGRX à créer les siens pour vous permettre d'avoir vos stores, reducers
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDAwMDI5NjQ5XX0=
-->