...
**Redux DevTools** vous permettra de voir chaques changements de state, de conserver un historique et de faire un export de vos states et inversement.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg2MDQ2MDU1OSw3ODQyMjE2NDhdfQ==
-->