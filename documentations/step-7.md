...
Avec un **Guard Angular**, le simple fait d'aller sur l'url */todo-list* nous permettra de vérifier si elle est chargée ( grâce à la propriété *loaded* ) et dans le cas où il n'y a pas de données, il déclenchera l'action **LoadInitTodos**.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODU3NjY4NjMzLDc4NDIyMTY0OF19
-->