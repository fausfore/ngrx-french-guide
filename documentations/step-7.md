...
Pour le moment c'est toujours **AllTodosComponent** qui donne le go pour lancé le chargement des todos, on pourrai chargé avoir besoin de chargé cette liste   mais on peut l'extraire également et l'intégrée a un **Guard Angular** qui vérifiera si la donnée est déjà chargée ( vérifiable par la propriété loaded ) dans le cas ou il n'y a pas de donnée, il enverra l'action **LoadInitTodos**.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MzAzMDExNl19
-->