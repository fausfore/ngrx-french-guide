...
Pour le moment c'est toujours **AllTodosComponent** qui donne dle go pour lançé le chargement des todos mais  mais on peut l'extraire également et l'intégrée a un **Guard Angular** qui vérifiera si la donnée est déjà chargée ( vérifiable par la propriété loaded ) dans le cas ou il n'y a pas de donnée, il enverra l'action **LoadInitTodos**.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEzNTk1NjAxNV19
-->